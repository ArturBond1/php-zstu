...
<html>
<head>
    <title>Додати нове лікування</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-5">
    <h1>Додати нове лікування</h1>
        ...
        <div class="mb-3">
            ...
            <select name="appointment_id" id="appointment_id" class="form-select" required>
                ...
                @foreach ($appointments as $appointment)
                    <option value="{{ $appointment->id }}">Прийом #{{ $appointment->id }} (Пацієнт: {{ $appointment->patient->first_name }} {{ $appointment->patient->last_name }}, Лікар: {{ $appointment->doctor->first_name }} {{ $appointment->doctor->last_name }})</option>
                @endforeach
            </select>
        </div>
